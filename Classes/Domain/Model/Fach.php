...
class Fach extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity {
     ...
     * Adds a Pruefling
     *
     * @param \ReRe\Rere\Domain\Model\Pruefling $matrikelnrADD
     * @return void
     */
    public function addMatrikelnr(\ReRe\Rere\Domain\Model\Pruefling $matrikelnrADD) {
        $this->matrikelnr->attach($matrikelnrADD);
    }
     ...
     * Sets the note
     *
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\ReRe\Rere\Domain\Model\Note> $noteSET
     * @return void
     */
