...
$GLOBALS['TCA']['tx_rere_domain_model_fach'] = array(
    ...
    'columns' => array(
        ...
        'matrikelnr' => array(
            'exclude' => 1,
            'label' => 'LLL:EXT:kaka/Resources/Private/Language/locallang_db.xlf:tx_kaka_domain_model_fach.matrikelnr',
            'config' => array(
                'type' => 'select',
                'foreign_table' => 'tx_kaka_domain_model_pruefling',
                'MM' => 'tx_kaka_fach_pruefling_mm',
                'size' => 10,
                'autoSizeMax' => 30,
                'maxitems' => 9999,
                'multiple' => 0,
                'wizards' => array(
                    ...
                    'add' => Array(
                        ...
                        'icon' => 'add.gif',
                        'params' => array(
                            'table' => 'tx_kaka_domain_model_pruefling',
                            'pid' => '###CURRENT_PID###',
                            'setValue' => 'prepend'
                        ),
