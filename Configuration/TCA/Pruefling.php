...
$GLOBALS['TCA']['tx_rere_domain_model_pruefling'] = array(
    ...
    'interface' => array(
	'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, matrikelnr, vorname, nachname, typo3_f_e_user, note',
    ),
    'types' => array(
	'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, matrikelnr, vorname, nachname, typo3_f_e_user, note, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
    ),
    'palettes' => array(
	'1' => array('showitem' => ''),
    ),
	...
	'prueflingname' => array(
	    'exclude' => 1,
	    'label' => 'LLL:EXT:rere/Resources/Private/Language/locallang_db.xlf:tx_rere_domain_model_pruefling.prueflingname',
	    'config' => array(
		'type' => 'input',
		'size' => 30,
		'eval' => 'trim'
	...
	'note' => array(
	    'exclude' => 1,
	    'label' => 'LLL:EXT:rere/Resources/Private/Language/locallang_db.xlf:tx_rere_domain_model_pruefling.note',
	    'config' => array(
		'type' => 'inline',
		'foreign_table' => 'tx_rere_domain_model_note',
		'foreign_field' => 'pruefling',
		'maxitems' => 9999,
		'appearance' => array(
		    'collapseAll' => 0,
		    'levelLinksPosition' => 'top',
