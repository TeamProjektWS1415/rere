# -*- coding: utf-8 -*-
#
# Result Repositry documentation build configuration file, created by
# TYPO3 extension sphinx on Fri, 02 Jan 2015 17:45:31 +0100.
#
...
project = u'Result Repositry'
copyright = u'2015, Felix Hohlwegler, Sarah Kieninger, Tim Wacker, Nejat Balta, Tobias Brockner, Nicolas Tedjadharma'
...
latex_documents = [
    ('Index', 'rere.tex', u'Result Repositry',
     u'Felix Hohlwegler, Sarah Kieninger, Tim Wacker, Nejat Balta, Tobias Brockner, Nicolas Tedjadharma', 'manual'),
]
...
pdf_documents = [
    ('Index', 'rere', u'Result Repositry',
     u'Felix Hohlwegler, Sarah Kieninger, Tim Wacker, Nejat Balta, Tobias Brockner, Nicolas Tedjadharma'),
]
...
man_pages = [
    ('Index', 'rere', u'Result Repositry',
     [u'Felix Hohlwegler, Sarah Kieninger, Tim Wacker, Nejat Balta, Tobias Brockner, Nicolas Tedjadharma'], 1)
]
...
texinfo_documents = [
    ('Index', 'rere', u'Result Repositry',
     u'Felix Hohlwegler, Sarah Kieninger, Tim Wacker, Nejat Balta, Tobias Brockner, Nicolas Tedjadharma', 'Result Repositry', 'One line description of project.',
     'Miscellaneous'),
]
