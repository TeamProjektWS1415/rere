...
if (TYPO3_MODE === 'BE') {
    ...
    \TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
            ...
            '', // Position
            array(
        'Modul' => 'list, show, new, newFach, create, edit, update, delete', 'Fach' => 'list, show, new, create, edit, update, delete', 'Note' => 'list, show, new, create, edit, update, delete', 'Pruefling' => 'list, show, new, create, edit, update, delete',
            ), array(
        'access' => 'user,group',
